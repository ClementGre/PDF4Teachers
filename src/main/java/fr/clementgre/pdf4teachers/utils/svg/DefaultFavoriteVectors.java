...
public class DefaultFavoriteVectors {
    ...
    private static final VectorData ARROW = new VectorData(20000, 7000, GraphicElement.RepeatMode.STRETCH, GraphicElement.ResizeMode.OPPOSITE_CORNERS,
            false, CYAN_TRANSPARENT, Color.DARKBLUE, 2, "M0 1 L1 0", false, false, 20, 0, 0, null);
    ...
    private static final VectorData LINE = new VectorData(20000, 20000, GraphicElement.RepeatMode.STRETCH, GraphicElement.ResizeMode.OPPOSITE_CORNERS,
            false, CYAN_TRANSPARENT, Color.DARKRED, 2, "M0 1 L1 0", false, false, 0, 0, 0, null);
    ...
    private static final VectorData CIRCLE = new VectorData(30000, 30000, GraphicElement.RepeatMode.AUTO, GraphicElement.ResizeMode.CORNERS,
            false, CYAN_TRANSPARENT, Color.DARKRED, 3, "M1.5,1 C1.5,2 0,2 0,1 C0,0 1.5,0 1.5,1", false, false, 0, 0, 0, null);
    ...
    private static final VectorData RECT = new VectorData(40000, 30000, GraphicElement.RepeatMode.STRETCH, GraphicElement.ResizeMode.CORNERS,
            false, CYAN_TRANSPARENT, Color.DARKRED, 3, "M0 0 L1 0 L1 1 L0 1 L0 0 z", false, false, 0, 0, 0, null);
    ...
    private static final VectorData RECT_FILL = new VectorData(40000, 30000, GraphicElement.RepeatMode.STRETCH, GraphicElement.ResizeMode.CORNERS,
            true, CYAN_TRANSPARENT, Color.DARKBLUE, 3, "M0 0 L1 0 L1 1 L0 1 L0 0 z", false, false, 0, 0, 0, null);
    ...
    private static final VectorData WAVES_ROUGH = new VectorData(50000, 5000, GraphicElement.RepeatMode.MULTIPLY, GraphicElement.ResizeMode.SIDE_EDGES,
            false, CYAN_TRANSPARENT, Color.DARKRED, 1, "M0 1 L1 0 L2 1 M0 -7", false, false, 0, 0, 0, null);
    ...
    public static final VectorData DOTS = new VectorData(50000, 5000, GraphicElement.RepeatMode.MULTIPLY, GraphicElement.ResizeMode.SIDE_EDGES,
            false, CYAN_TRANSPARENT, Color.DARKRED, 2, "M0 1 L0 1 M2 -7", false, false, 0, 0, 0, null);
    ...
    public static final VectorData UNDERLINE_SMALL_LINES = new VectorData(50000, 5000, GraphicElement.RepeatMode.MULTIPLY, GraphicElement.ResizeMode.SIDE_EDGES,
            false, CYAN_TRANSPARENT, Color.DARKRED, 1, "M0 1 L1 1 M2 -7", false, false, 0, 0, 0, null);
    ...
    public static final VectorData UNDERLINE_LONG_LINES = new VectorData(50000, 5000, GraphicElement.RepeatMode.MULTIPLY, GraphicElement.ResizeMode.SIDE_EDGES,
            false, CYAN_TRANSPARENT, Color.DARKRED, 1, "M0 1 L5 1 M7 -7", false, false, 0, 0, 0, null);
    ...
    public static final VectorData WAVES = new VectorData(50000, 5000, GraphicElement.RepeatMode.MULTIPLY, GraphicElement.ResizeMode.SIDE_EDGES,
            false, CYAN_TRANSPARENT, Color.DARKRED, 1, "M 0 20 Q20 0, 40 20 Q60 40, 80 20 M80 -100", false, false, 0, 0, 0, null);
    ...
    private static final VectorData HIGHLIGHTER = new VectorData(50000, 5000, GraphicElement.RepeatMode.STRETCH, GraphicElement.ResizeMode.SIDE_EDGES,
            true, YELLOW_TRANSPARENT, Color.DARKRED, 0, "M0 0 L1 0 1 1 0 1 z", false, false, 0, 0, 0, null);
    ...
    private static final VectorData HIGHLIGHTER_CYAN = new VectorData(50000, 5000, GraphicElement.RepeatMode.STRETCH, GraphicElement.ResizeMode.SIDE_EDGES,
            true, CYAN_TRANSPARENT, Color.DARKRED, 0, "M0 0 L1 0 1 1 0 1 z", false, false, 0, 0, 0, null);
    ...
    private static final VectorData CHECK = new VectorData(6000, 4474, GraphicElement.RepeatMode.KEEP_RATIO, GraphicElement.ResizeMode.CORNERS,
            true, Color.color(0, 163 / 255d, 0), Color.GREEN, 0, "M173.898 439.404l-166.4-166.4c-9.997-9.997-9.997-26.206 0-36.204l36.203-36.204c9.997-9.998 26.207-9.998 36.204 0L192 312.69 432.095 72.596c9.997-9.997 26.207-9.997 36.204 0l36.203 36.204c9.997 9.997 9.997 26.206 0 36.204l-294.4 294.401c-9.998 9.997-26.207 9.997-36.204-.001z",
    ...
    private static final VectorData FAT_HORIZONTAL_ARROW = new VectorData(10000, 9746, GraphicElement.RepeatMode.KEEP_RATIO, GraphicElement.ResizeMode.CORNERS,
            true, CYAN_TRANSPARENT, Color.NAVY, 2, "M190.5 66.9l22.2-22.2c9.4-9.4 24.6-9.4 33.9 0L441 239c9.4 9.4 9.4 24.6 0 33.9L246.6 467.3c-9.4 9.4-24.6 9.4-33.9 0l-22.2-22.2c-9.5-9.5-9.3-25 .4-34.3L311.4 296H24c-13.3 0-24-10.7-24-24v-32c0-13.3 10.7-24 24-24h287.4L190.9 101.2c-9.8-9.3-10-24.8-.4-34.3z",
            false, false, 0, 0, 0, null);
    ...
    public static final VectorData BRACE = new VectorData(5000, 15000, GraphicElement.RepeatMode.STRETCH, GraphicElement.ResizeMode.CORNERS,
            false, CYAN_TRANSPARENT, Color.RED, 2, "M92.5 3C58.3998 4.89659 49.9581 16.2201 52 60V102.5C50.919 123.22 31.6772 129.531 3 136.5V139C29.7825 144.466 52.1691 152.636 52 182V223C49.7643 261.252 60.7593 274.807 92.5 276",
            false, false, 0, 0, 0, null);
