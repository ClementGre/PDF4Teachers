...
public class DefaultFavoriteVectors {
    ...
    private static final VectorData LINE = new VectorData(20000, 20000, GraphicElement.RepeatMode.STRETCH, GraphicElement.ResizeMode.OPPOSITE_CORNERS,
            false, CYAN_TRANSPARENT, Color.DARKRED, 2, "M0 1 L1 0", false, false, 0, 0, 0);
    ...
    private static final VectorData HIGHLIGHTER_CYAN = new VectorData(50000, 5000, GraphicElement.RepeatMode.STRETCH, GraphicElement.ResizeMode.SIDE_EDGES,
            true, CYAN_TRANSPARENT, Color.DARKRED, 0, "M0 0 L1 0 1 1 0 1 z", false, false, 0, 0, 0);
    ...
    private static final VectorData CHECK = new VectorData(6000, 4474, GraphicElement.RepeatMode.KEEP_RATIO, GraphicElement.ResizeMode.CORNERS,
            true, Color.color(0, 163 / 255d, 0), Color.GREEN, 0, "M173.898 439.404l-166.4-166.4c-9.997-9.997-9.997-26.206 0-36.204l36.203-36.204c9.997-9.998 26.207-9.998 36.204 0L192 312.69 432.095 72.596c9.997-9.997 26.207-9.997 36.204 0l36.203 36.204c9.997 9.997 9.997 26.206 0 36.204l-294.4 294.401c-9.998 9.997-26.207 9.997-36.204-.001z", false, false, 0, 0, 0);
    ...
    public static final VectorData BRACE = new VectorData(5000, 15000, GraphicElement.RepeatMode.STRETCH, GraphicElement.ResizeMode.CORNERS,
            false, CYAN_TRANSPARENT, Color.RED, 2, "M92.5 3C58.3998 4.89659 49.9581 16.2201 52 60V102.5C50.919 123.22 31.6772 129.531 3 136.5V139C29.7825 144.466 52.1691 152.636 52 182V223C49.7643 261.252 60.7593 274.807 92.5 276", false, false, 0, 0, 0);
