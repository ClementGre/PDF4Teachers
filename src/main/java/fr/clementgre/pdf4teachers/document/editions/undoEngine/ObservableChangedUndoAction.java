    ...
    public boolean undoAndInvert(){
        if(observable.get() != null){
            ...
            if(!(value instanceof String)){
                ...
                //  When element scale to page is performed, UndoType is UType.ELEMENT_NO_COUNT_BEFORE => We need to quit the edit mode
                if(element.isEditMode() && getUndoType() == UType.ELEMENT_NO_COUNT_BEFORE){
            ...
            if(!(value instanceof String)){
                ...
                // When element scale to page is performed, UndoType is UType.ELEMENT_NO_COUNT_AFTER. And in this case, dimensions must not be corrected.
                if(vectorElementBeforeBounds != null && !element.isEditMode() && getUndoType() == UType.ELEMENT)
