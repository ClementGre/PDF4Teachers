...
the downloaded code, and the Java JDK 17 (should be in the environment variable ``JAVA_HOME``). Gradle is using some
...
- **[WiX Toolset](https://wixtoolset.org/)** is a JPackage dependency, it allows to build .msi file. Needs to be
